      ...
      <Container>
        <Box sx={styles.contentBox}>
          <Box sx={styles.contentBoxInner}>
            ...
            <Text as="p" sx={styles.description}>
              Manila Branch: Jade Tower Condominium, 2nd Avenue, Grace Park West, Caloocan, Metro Manila, Philippines
            </Text>
            <Text as="p" sx={styles.description}>
              Email: jercontrade@gmail.com
            </Text>
            <Text as="p" sx={styles.description}>
              Contact Number: +639173215259 | +639178128999
            </Text>
          </Box>
        </Box>
      </Container>
